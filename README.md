<h1 align="center" style="margin: 30px 0 30px; font-weight: bold;">CMS System</h1>
<h4 align="center">基于SpringBoot3、Vue3的内容管理系统</h4>
<p align="center">
...
> 基于现代化技术栈构建的内容管理系统（CMS），旨在为企业和组织提供一个**灵活、简洁、高效**的内容管理解决方案。系统采用前后端分离架构，拥抱最新的技术趋势，助力内容管理和发布流程的数字化转型。

**CMS System** ，一个基于 Spring Boot 3、Vue 3 和 Element-Plus 的开源内容管理系统，致力于为您提供一个流畅、直观且功能强大的内容管理平台。它不仅融合了最新的技术趋势，而且通过精心设计，确保了系统的简洁性和高效，让内容创作者和管理者可以专注于内容本身。



## 在线体验

- 官网地址：https://cms-system.example.com
- 文档地址：https://docs.cms-system.example.com
- 预览地址：https://preview.cms-system.example.com
- 代码仓库：
    - 前端：
      - **Github**：**[cms-system-frontend](https://github.com/chenbin0702/cms-system-frontend.git)**
    - 后端：
      - **Github**：**[cms-system](https://github.com/chenbin0702/cms-system.git)**
    - 部署：
      - **Github**：**[cms-system-deploy](https://github.com/chenbin0702/cms-system-deploy.git)**
