...
-- ----------------------------
-- Records of cms_category (初始化数据)
-- ----------------------------
INSERT INTO `cms_category` VALUES (1, '系统公告', 0, 1, 100, 'F', 'enable', 'icon-notice', '系统相关公告信息', '系统,公告,通知', '系统公告和重要通知信息发布', 'F', 1, 1, NOW(), NOW());
INSERT INTO `cms_category` VALUES (2, '新闻资讯', 0, 1, 200, 'T', 'enable', 'icon-news', '新闻资讯内容', '新闻,资讯,动态', '最新新闻资讯和行业动态', 'F', 1, 1, NOW(), NOW());
INSERT INTO `cms_category` VALUES (3, '行业新闻', 2, 2, 100, 'F', 'enable', 'icon-industry', '行业相关新闻', '行业,新闻', '行业相关的新闻资讯', 'F', 1, 1, NOW(), NOW());
INSERT INTO `cms_category` VALUES (4, '公司动态', 2, 2, 200, 'F', 'enable', 'icon-company', '公司内部动态', '公司,动态', '公司内部最新动态信息', 'F', 1, 1, NOW(), NOW());
INSERT INTO `cms_category` VALUES (5, '技术文档', 0, 1, 300, 'F', 'enable', 'icon-tech', '技术相关文档', '技术,文档,开发', '技术开发相关的文档资料', 'F', 1, 1, NOW(), NOW());

-- ----------------------------
-- Records of cms_category_closure (初始化闭包表数据)
-- ----------------------------
INSERT INTO `cms_category_closure` VALUES (1, 1, 0);
INSERT INTO `cms_category_closure` VALUES (2, 2, 0);
INSERT INTO `cms_category_closure` VALUES (2, 3, 1);
INSERT INTO `cms_category_closure` VALUES (2, 4, 1);
INSERT INTO `cms_category_closure` VALUES (3, 3, 0);
INSERT INTO `cms_category_closure` VALUES (4, 4, 0);
INSERT INTO `cms_category_closure` VALUES (5, 5, 0);
